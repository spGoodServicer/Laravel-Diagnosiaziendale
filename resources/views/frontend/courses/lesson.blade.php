                    ...
                    <div class="course-details-item border-bottom-0 mb-0">
                        ...
                        @if ($test_exists)
                            ...
                            @else
                                ...
                                <div class="test-form">
                                    @if(count($lesson->questions) > 0  )
                                        <form action="{{ route('lessons.test', [$lesson->slug]) }}"  id="quizform"  method="post">
                                            @csrf
...
function storeFun(newid,varvalue){
			var arr = [];
    ...
    <script>
        ...
        $(".square-check").click(function(){
            var opendivid = $(this).find('input[type=checkbox]').data('opendiv')
    ...
    $("#file").on('change', function(e) {
        ...
        /*var questions = $(".question-card").length;
        var $current_page = 1;
        if(questions>10){
            $("#navigation-btns").show();
            $("#pre-pg").prop('disabled',true);
            $("#create-report").hide();
