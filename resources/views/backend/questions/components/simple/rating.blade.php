...
<div id="rating_part" class="row question-box" @if(isset($display)) style="display:{{$display}};" @endif>
    <div class="col-2">
        ...
        <div class="mb-3">
            ...
            <input type="color" name="color" id="rating_color" class="form-control" value="@if(isset($content) && isset($content->color)){{$content->color}}@endif">
        </div>
    </div>
    <div class="col-6" >
        <label for="">Select Display</label>
        <select name="rating_display" class="form-control" id="rating_display">
